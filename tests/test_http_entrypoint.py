...
class HttpEntrypointTest(unittest.TestCase):
    ...
    def test_frontend_uses_agent_safe_vision_routing_without_manual_mode_picker(self):
        ...
        self.assertIn("Agent 会按 Skill evidence protocol 自动选择安全视觉链路", html)
    ...
    def test_frontend_exposes_skill_selection_modes_without_vision_mode_picker(self):
        ...
        self.assertIn("manualSecondarySkillSelection", html)
        self.assertIn("主 Skill 单路", html)
        self.assertIn("人工备用 Skill", html)
        self.assertIn("Agent 自动多 Skill", html)
        self.assertIn('type="hidden" id="manualSecondarySkills"', html)
        ...
        self.assertIn("selectManualSecondarySkill", js)
        self.assertIn("data-secondary-skill-key", js)
        self.assertIn("加入备用复查", js)
        self.assertIn("已选择备用复查", js)
        self.assertNotIn("visionModeSelect", html)
    ...
    def test_frontend_exposes_collapsible_fhn_skill_protocol_comparison(self):
        ...
        self.assertIn("skill-quantification-details", js)
