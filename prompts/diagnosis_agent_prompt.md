...
- 对缺失或未评估证据，输出 JSON 全文禁止出现“排除”“阴性”“无病”“未发现”“正常”等词面，即使是否定句也不要使用；改写为“证据不足，需补充 MRI/专科复核”“当前 X 光不能完成该项评估”“尚需进一步确认”“当前证据不足以完成该判断”。
- 可以把“X 光未见明确异常/未见明显异常”作为当前 X 光观察记录，但必须同时说明普通 X 光不能据此判断无病或完成早期股骨头坏死排查，建议 MRI 进一步评估。
